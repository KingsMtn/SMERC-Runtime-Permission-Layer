...
class CommunityPartnerDocsTests(unittest.TestCase):
    ...
    def test_issue_templates_cover_partner_and_scenario_paths(self):
        ...
        self.assertTrue((templates / "workflow-intake-template.md").exists())
        ...
        workflow = (templates / "workflow-intake-template.md").read_text(encoding="utf-8")
        shadow = (templates / "smerc_shadow_intake.yml").read_text(encoding="utf-8")
