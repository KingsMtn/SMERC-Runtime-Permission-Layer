    ...
    return {
        ...
        "tool_plan": {
            ...
            "metadata": {
                ...
                "source_observation": _optional_text(row.get("source_observation")),
                "label_basis": _optional_text(row.get("label_basis")),
                "label_confidence": _optional_text(row.get("label_confidence")),
