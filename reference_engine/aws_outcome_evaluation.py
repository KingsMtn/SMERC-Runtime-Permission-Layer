...
def evaluate_record(record: Mapping[str, Any]) -> dict[str, Any]:
    ...
    # Execution evidence can test coherence and recovery, but it cannot label its
    # own decision correct. That requires independent outcome or reviewer input.
...
def evaluate_records(records: Iterable[Mapping[str, Any]], *, observed_at: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "summary": {
            ...
            "judgment_correctness_rate": None,
        },
...
def main() -> int:
    ...
    report = evaluate_records(load_records(args.inputs))
