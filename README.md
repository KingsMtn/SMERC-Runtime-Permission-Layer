...
- Microsoft-style security replay adapter for Sentinel, Defender, Azure Activity, and advanced-hunting shaped events that compares current workflow outcomes with SMERC recoverability posture before response execution
