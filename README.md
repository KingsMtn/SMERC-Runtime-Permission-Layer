...
The Unified Decision Pipeline Contract keeps hard permission gates, mathematical recoverability
...
- `docs/AWS_Shadow_Mirror_Customer_Metadata_Request.md` gives reviewers the clean ask for 5 to 25 sanitized mirror-derived flow summaries from one owned workflow.
...
- `docs/AWS_Outcome_Evaluation.md` verifies portable AWS records, measures decision/execution coherence and recovery evidence, and leaves judgment correctness unlabeled until independent evidence exists.
...
Run the AWS Agent Action Chain proof:
...
Run the Recoverability Metadata Contract:
