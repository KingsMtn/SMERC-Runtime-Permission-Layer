...
| ---: | --- | --- | --- | --- | --- | --- | --- |
| 1 | `EXAMPLECO_GHA_TESTS_001` | `pass` | `admitted_with_agent_identity_watch` | `ALLOW` | `EXECUTE` | `True` | `True` |
| 2 | `EXAMPLECO_PROD_CANARY_002` | `pass` | `admitted_with_agent_identity_watch` | `THROTTLE` | `CONSTRAINED_EXECUTE` | `True` | `True` |
| 3 | `EXAMPLECO_MCP_DELETE_RECORDS_003` | `pass` | `admitted_with_agent_identity_watch` | `DENY` | `BLOCK` | `False` | `True` |
