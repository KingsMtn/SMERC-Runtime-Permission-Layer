...
| ---: | --- | --- | --- | --- | --- | --- | --- |
| 1 | `SMERCF_REFUND_BATCH_001` | `pass` | `admitted_with_agent_identity_watch` | `THROTTLE` | `CONSTRAINED_EXECUTE` | `True` | `True` |
| 2 | `SMERCF_TREASURY_REBALANCE_002` | `pass` | `admitted_with_agent_identity_watch` | `ALLOW` | `EXECUTE` | `True` | `True` |
| 3 | `SMERCF_STABLECOIN_BRIDGE_003` | `pass` | `admitted_with_agent_identity_watch` | `DENY` | `BLOCK` | `False` | `True` |
| 4 | `SMERCF_PAYMENT_RETRY_004` | `pass` | `admitted_with_agent_identity_watch` | `THROTTLE` | `CONSTRAINED_EXECUTE` | `True` | `True` |
| 5 | `SMERCF_WALLET_POLICY_005` | `fail` | `capped_by_ref_gate` | `DENY` | `BLOCK` | `False` | `True` |
| 6 | `SMERCF_COLLATERAL_MOVE_006` | `pass` | `admitted_with_agent_identity_watch` | `THROTTLE` | `CONSTRAINED_EXECUTE` | `True` | `True` |
| 7 | `SMERCF_LIMIT_CHANGE_007` | `pass` | `admitted_with_agent_identity_watch` | `THROTTLE` | `CONSTRAINED_EXECUTE` | `True` | `True` |
