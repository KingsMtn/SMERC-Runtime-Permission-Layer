...
Generated: `2026-08-27T02:20:55+00:00`
...
- SMERC posture counts: `{'DENY': 3, 'THROTTLE': 2}`
- Decisions that differ: `4` (`0.8`)
...
| `FILLED_MCP_002` | `REVIEW` | `DENY` | `True` | 0.896 | 0.241 | SMERC broadly agrees with the current control posture. |
...
- `FILLED_MCP_002`: `DENY` with exposure `0.896`. Consequence: Incorrect deletion could create data loss, customer harm, and recovery work.
