...
- Result: Measured 4 proof workloads across 1 iteration(s) each with slowest p95 of 4.254 ms.
...
| --- | ---: | ---: | ---: | ---: | --- |
| `customer_evaluation_general` | 1 | 2.332 | 2.332 | 2.332 | actions=5, valid_ledgers=5, postures={'ALLOW': 1, 'DENY': 3, 'THROTTLE': 1} |
| `cloud_metadata_connector` | 1 | 2.812 | 2.812 | 2.812 | actions=6, valid_ledgers=6, postures={'DENY': 3, 'THROTTLE': 3} |
| `public_benchmark_ingestion` | 1 | 4.254 | 4.254 | 4.254 | actions=10, valid_ledgers=10, postures={'ALLOW': 2, 'DENY': 6, 'THROTTLE': 2} |
| `postcondition_evidence` | 1 | 3.754 | 3.754 | 3.754 | actions=10, observed=5, statuses={'gap': 1, 'pass': 4, 'unobserved': 5} |
