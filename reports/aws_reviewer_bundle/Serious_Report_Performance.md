...
- Result: Measured 4 proof workloads across 1 iteration(s) each with slowest p95 of 13.002 ms.
...
| --- | ---: | ---: | ---: | ---: | --- |
| `customer_evaluation_general` | 1 | 4.136 | 4.136 | 4.136 | actions=5, valid_ledgers=5, postures={'ALLOW': 1, 'DENY': 3, 'THROTTLE': 1} |
| `cloud_metadata_connector` | 1 | 6.504 | 6.504 | 6.504 | actions=6, valid_ledgers=6, postures={'DENY': 3, 'THROTTLE': 3} |
| `public_benchmark_ingestion` | 1 | 13.002 | 13.002 | 13.002 | actions=10, valid_ledgers=10, postures={'ALLOW': 2, 'DENY': 6, 'THROTTLE': 2} |
| `postcondition_evidence` | 1 | 9.127 | 9.127 | 9.127 | actions=10, observed=5, statuses={'gap': 1, 'pass': 4, 'unobserved': 5} |
