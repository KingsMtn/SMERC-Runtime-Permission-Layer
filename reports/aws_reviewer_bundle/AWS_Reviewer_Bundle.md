...
- Result: Generated an AWS reviewer bundle with 8 action-chain examples, chain postcondition statuses {'gap': 1, 'pass': 7}, AWS postcondition statuses {'gap': 2, 'pass': 4}, and slowest local p95 4.078 ms.
...
| Performance | status=`ready_for_local_review`, slowest_p95_ms=`4.078` |
