...
- Route report digest: `78c27814a481b096690ae867950f736ce8315fc3cb0e38bb8f362c2c22a7e36d`

## 5. Decision Lifecycle Ledger

- Ledger ID: `dll_replay_AI_AUTH_MIDDLEWARE_PR_1788272742369`
- Record count: `7`
- Head hash: `a89b7132c6016766b5740199c1f5587375745ce65d3c514fbbeb428d1e7fa357`
...
- Decision evaluation: `0.141 ms`
- PR certificate: `0.207 ms`
- PR comment render: `0.027 ms`
- SPARTa route: `0.433 ms`
- DLL build: `0.273 ms`
- DLL Intelligence: `1.641 ms`
- Total local proof-loop generation: `2.857 ms`
